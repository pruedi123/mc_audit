...
DATA_DIR = Path("/Users/paulruedi/Desktop/glob_spx")
...
try:
    df_global = pd.read_csv(DATA_DIR / "global_factors.csv", sep=None, engine="python")
...
try:
    df_spx = pd.read_csv(DATA_DIR / "spx_factors.csv", sep=None, engine="python")
